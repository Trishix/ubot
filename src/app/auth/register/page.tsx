                ...
                <div className="border border-white/5 bg-[#050505] p-10">
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-[11px] font-black text-white uppercase tracking-[0.2em] font-mono">Username</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/[0.02] border border-white/5 py-4 pl-10 pr-4 focus:outline-none focus:border-primary/50 transition-all text-white font-mono placeholder:text-white/20"
                                    value={username}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/80" />
                                <input
                                    type="password"
                                    required
                                    placeholder="••••••••"
